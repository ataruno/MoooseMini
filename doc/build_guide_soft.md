...
- [インジケータについて](#インジケータについて)
  - [バッテリーの充電状態](#バッテリーの充電状態)
  - [Bluetooth接続状態](#bluetooth接続状態)
- [キーマップの変更](#キーマップの変更)
  - [デフォルトで固定のもの](#デフォルトで固定のもの)
  - [(1) ZMK Studioを使用する場合](#1-zmk-studioを使用する場合)
  - [(2) ZMK Firmwareを使用する場合](#2-zmk-firmwareを使用する場合)
...
マイコンリセットスイッチはトラックボールをどかすと見えるタクトスイッチです。  
...
uf2ファイルの置き場：[リンク](https://github.com/ataruno/MoooseMini/tree/main/firmware)  
...
### デフォルトで固定のもの
キーマップ変更に入る前に、ZMK studioでは変えられない固定箇所の説明です。  
